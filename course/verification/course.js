...
const CourseProgress = {
  ...
  readings: [
    ...
    { id: 'unit-1-reading-3', unit: 1, reading: '1.3', title: 'Risks from power-seeking AI', href: '/course/verification/1.html#read-1-3' },
    { id: 'unit-1-reading-4', unit: 1, reading: '1.4', title: 'Extreme power concentration', href: '/course/verification/1.html#read-1-4' },
    { id: 'unit-1-reading-5', unit: 1, reading: '1.5', title: 'Components of a frontier AI slowdown', href: '/course/verification/1.html#read-1-5' },
    { id: 'unit-1-reading-6', unit: 1, reading: '1.6', title: 'Avoiding an AI Arms Race with Assurance Technologies', href: '/course/verification/1.html#read-1-6' },
    { id: 'unit-1-reading-7', unit: 1, reading: '1.7', title: 'Computing Power and the Governance of Artificial Intelligence', href: '/course/verification/1.html#read-1-7' },
    { id: 'unit-1-reading-8', unit: 1, reading: '1.8', title: 'Verification Is a Ladder', href: '/course/verification/1.html#read-1-8' },
    { id: 'unit-1-reading-9', unit: 1, reading: '1.9', title: 'Nuclear Arms Control Verification and Lessons for AI Treaties', href: '/course/verification/1.html#read-1-9' },
    { id: 'unit-1-reading-10', unit: 1, reading: '1.10', title: 'Hardware-Enabled Mechanisms for Verifying Responsible AI Development', href: '/course/verification/1.html#read-1-10' },
    { id: 'unit-1-reading-11', unit: 1, reading: '1.11', title: 'Frontier AI Auditing', href: '/course/verification/1.html#read-1-11' },
    { id: 'unit-1-reading-12', unit: 1, reading: '1.12', title: 'Open Problems in Technical AI Governance', href: '/course/verification/1.html#read-1-12' },
    { id: 'unit-1-reading-13', unit: 1, reading: '1.13', title: 'Mechanisms to Verify International Agreements About AI Development', href: '/course/verification/1.html#read-1-13' },
    { id: 'unit-1-reading-14', unit: 1, reading: '1.14', title: 'Verification for International AI Governance', href: '/course/verification/1.html#read-1-14' },
    { id: 'unit-1-reading-15', unit: 1, reading: '1.15', title: 'Verifying International Agreements on AI', href: '/course/verification/1.html#read-1-15' },
    { id: 'unit-1-reading-16', unit: 1, reading: '1.16', title: 'Hardware-Level Governance of AI Compute', href: '/course/verification/1.html#read-1-16' },
    { id: 'unit-1-reading-17', unit: 1, reading: '1.17', title: 'On restraining AI development for the sake of safety', href: '/course/verification/1.html#read-1-17' },
    ...
    { id: 'unit-3-reading-9', unit: 3, reading: '3.9', title: 'Efficient Zero-Knowledge Proofs for AI Inference', href: '/course/verification/3.html#read-3-9' },
    { id: 'unit-3-reading-10', unit: 3, reading: '3.10', title: 'Verifiable evaluations of machine learning models using zkSNARKs', href: '/course/verification/3.html#read-3-10' },
    { id: 'unit-3-reading-11', unit: 3, reading: '3.11', title: 'zkLLM: Zero Knowledge Proofs for Large Language Models', href: '/course/verification/3.html#read-3-11' },
    { id: 'unit-3-reading-12', unit: 3, reading: '3.12', title: 'ZKML: An Optimizing System for ML Inference in Zero-Knowledge Proofs', href: '/course/verification/3.html#read-3-12' },
    { id: 'unit-3-reading-13', unit: 3, reading: '3.13', title: 'Handling floating point in ZK inference verification', href: '/course/verification/3.html#read-3-13' },
    { id: 'unit-3-reading-14', unit: 3, reading: '3.14', title: 'Architecture-private Zero-knowledge Proof of Neural Networks', href: '/course/verification/3.html#read-3-14' },
    { id: 'unit-3-reading-15', unit: 3, reading: '3.15', title: 'NANOZK: Layerwise Zero-Knowledge Proofs for Verifiable LLM Inference', href: '/course/verification/3.html#read-3-15' },
    { id: 'unit-3-reading-16', unit: 3, reading: '3.16', title: 'Hollow-LLM Attack: Computationally Trivial Weights in Zero-Knowledge Verification of LLM Inference', href: '/course/verification/3.html#read-3-16' },
    { id: 'unit-3-reading-17', unit: 3, reading: '3.17', title: 'Physical Verification of AI Systems against Nation-state Adversaries', href: '/course/verification/3.html#read-3-17' },
    { id: 'unit-3-reading-18', unit: 3, reading: '3.18', title: 'Timing and Memory Telemetry on GPUs for AI Governance', href: '/course/verification/3.html#read-3-18' },
    { id: 'unit-3-reading-19', unit: 3, reading: '3.19', title: 'Network Traffic Hashing', href: '/course/verification/3.html#read-3-19' },
    { id: 'unit-3-reading-20', unit: 3, reading: '3.20', title: 'Software-Based Memory Erasure with relaxed isolation requirements', href: '/course/verification/3.html#read-3-20' },
    { id: 'unit-3-reading-21', unit: 3, reading: '3.21', title: 'Memory Wipes, a Performance Analysis', href: '/course/verification/3.html#read-3-21' },
    { id: 'unit-3-reading-22', unit: 3, reading: '3.22', title: 'Off-Chip Compute Verification', href: '/course/verification/3.html#read-3-22' },
    { id: 'unit-3-reading-23', unit: 3, reading: '3.23', title: '“Energon”: Unveiling Transformers from GPU Power and Thermal Side-Channels', href: '/course/verification/3.html#read-3-23' },
    { id: 'unit-3-reading-24', unit: 3, reading: '3.24', title: 'International Governance of Civilian AI: A Jurisdictional Certification Approach', href: '/course/verification/3.html#read-3-24' },
    { id: 'unit-3-reading-25', unit: 3, reading: '3.25', title: 'Verification Methods for International AI Agreements', href: '/course/verification/3.html#read-3-25' },
    { id: 'unit-3-reading-26', unit: 3, reading: '3.26', title: 'Tools for verifying neural models\' training data', href: '/course/verification/3.html#read-3-26' },
