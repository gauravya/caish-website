...
const CourseProgress = {
  ...
  readings: [
    ...
    { id: 'unit-1-reading-5', unit: 1, reading: '1.5', title: 'Avoiding an AI Arms Race with Assurance Technologies', href: '/course/verification/1.html#read-1-5' },
    { id: 'unit-1-reading-6', unit: 1, reading: '1.6', title: 'Computing Power and the Governance of Artificial Intelligence', href: '/course/verification/1.html#read-1-6' },
    { id: 'unit-1-reading-7', unit: 1, reading: '1.7', title: 'Notes on Verification Strategy', href: '/course/verification/1.html#read-1-7' },
    ...
    { id: 'unit-2-reading-9', unit: 2, reading: '2.9', title: 'Attestable Audits: Verifiable AI Safety Benchmarks Using Trusted Execution Environments', href: '/course/verification/2.html#read-2-9' },
    { id: 'unit-2-reading-10', unit: 2, reading: '2.10', title: 'Governing Through the Cloud: The Intermediary Role of Compute Providers in AI Regulation', href: '/course/verification/2.html#read-2-10' },
    ...
    { id: 'unit-3-reading-5', unit: 3, reading: '3.5', title: 'Inference Verification in a TEE', href: '/course/verification/3.html#read-3-5' },
    { id: 'unit-3-reading-6', unit: 3, reading: '3.6', title: 'Verifying LLM Inference to Detect Model Weight Exfiltration', href: '/course/verification/3.html#read-3-6' },
    { id: 'unit-3-reading-7', unit: 3, reading: '3.7', title: 'DiFR: Inference Verification Despite Nondeterminism', href: '/course/verification/3.html#read-3-7' },
    { id: 'unit-3-reading-8', unit: 3, reading: '3.8', title: 'Efficient Zero-Knowledge Proofs for AI Inference', href: '/course/verification/3.html#read-3-8' },
    { id: 'unit-3-reading-9', unit: 3, reading: '3.9', title: 'Verifiable evaluations of machine learning models using zkSNARKs', href: '/course/verification/3.html#read-3-9' },
    { id: 'unit-3-reading-10', unit: 3, reading: '3.10', title: 'zkLLM: Zero Knowledge Proofs for Large Language Models', href: '/course/verification/3.html#read-3-10' },
    { id: 'unit-3-reading-11', unit: 3, reading: '3.11', title: 'ZKML: An Optimizing System for ML Inference in Zero-Knowledge Proofs', href: '/course/verification/3.html#read-3-11' },
    { id: 'unit-3-reading-12', unit: 3, reading: '3.12', title: 'Physical Verification of AI Systems against Nation-state Adversaries', href: '/course/verification/3.html#read-3-12' },
    { id: 'unit-3-reading-13', unit: 3, reading: '3.13', title: 'Timing and Memory Telemetry on GPUs for AI Governance', href: '/course/verification/3.html#read-3-13' },
    { id: 'unit-3-reading-14', unit: 3, reading: '3.14', title: 'Network Traffic Hashing', href: '/course/verification/3.html#read-3-14' },
    { id: 'unit-3-reading-15', unit: 3, reading: '3.15', title: 'Software-Based Memory Erasure with relaxed isolation requirements', href: '/course/verification/3.html#read-3-15' },
    { id: 'unit-3-reading-16', unit: 3, reading: '3.16', title: 'Memory Wipes, a Performance Analysis', href: '/course/verification/3.html#read-3-16' },
    { id: 'unit-3-reading-17', unit: 3, reading: '3.17', title: 'Off-Chip Compute Verification', href: '/course/verification/3.html#read-3-17' },
    { id: 'unit-3-reading-18', unit: 3, reading: '3.18', title: 'International Governance of Civilian AI: A Jurisdictional Certification Approach', href: '/course/verification/3.html#read-3-18' },
    { id: 'unit-3-reading-19', unit: 3, reading: '3.19', title: 'Verification Methods for International AI Agreements', href: '/course/verification/3.html#read-3-19' },
    { id: 'unit-3-reading-20', unit: 3, reading: '3.20', title: 'Tools for verifying neural models\' training data', href: '/course/verification/3.html#read-3-20' },
